...
![Mageplaza Turkish language pack](https://cdn3.mageplaza.com/media/general/qjWPj1W.png)
...
![Turkish language pack process](https://progress-bar.dev//?title=completed)
...
```
composer require mageplaza/magento-2-turkish-language-pack:dev-master mageplaza/module-smtp 
...
Unzip the compressed file and upload file `master.zip` into `app/i18n/Mageplaza/tr_tr/`

See this screenshot:

![Turkish pack](https://cdn3.mageplaza.com/media/general/language-pack.png)

This language pack code is: **tr_tr**
...
## 3. How to Active the Turkish language pack 
